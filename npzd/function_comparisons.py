...
F_I = ff.get_I(swrad0, z_rho, z_w, Chl)
B_I = bnf.get_E(swrad0, z_rho, z_w, Phy, 32)
#
ax = axes[0,1]
ax.plot(F_I, z_rho, '-', c='g', lw=3, label='Fennel')
ax.plot(B_I, z_rho, '--', c='g', lw=3, label='Banas')
ax.legend(loc='lower right')
