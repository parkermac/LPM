"""
Code to compare various observed and modeled bottle values for a collection
of sources.
...
source_list = ['ecology', 'dfo', 'nceiSalish', 'nceiCoastal']
# source_list = ['nceiSalish', 'nceiCoastal']
otype = 'bottle'
year = '2017'
...
gtx_list = ['cas6_v0_live', 'cas6_v00_uu0mb', 'cas6_v00_x0mb']
