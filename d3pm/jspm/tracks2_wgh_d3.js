...
function create_vis(data) {
    ...
    // This function fills out an array with the position of points at
    // a specific timestep
    let sxyNow = [];
    ...
    // This function moves all the points based on the time slider.
    function update_point_locations() {
        d3.select('#ax0')
            .selectAll('circle')
            .data(sxyNow)
            .join('circle')
