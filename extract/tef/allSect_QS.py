...
for ch_str in channel_list:
    ...
    if ch_str != 'Juan de Fuca to Strait of Georgia':
        ax4.plot(dist[1:],(s_s[1:]),'-', color=lcol, lw=lw)
        ax4.plot(dist[1:],(s_f[1:]),'-', color=lcol, lw=lw)
        ax4.plot(dist[:2],(s_s[:2]),'--', color='k', lw=1)
        ax4.plot(dist[:2],(s_f[:2]),'--', color='k', lw=1)
    else:
        ax4.plot(dist,(s_s),'-', color=lcol, lw=lw)
        ax4.plot(dist,(s_f),'-', color=lcol, lw=lw)
    ...
    if ch_str != 'Juan de Fuca to Strait of Georgia':
        ax5.plot(dist[1:],(s_s[1:]),'-', color=lcol, lw=lw)
        ax5.plot(dist[1:],(s_f[1:]),'-', color=lcol, lw=lw)
        ax5.plot(dist[:2],(s_s[:2]),'--', color='k', lw=1)
        ax5.plot(dist[:2],(s_f[:2]),'--', color='k', lw=1)
    else:
        ax5.plot(dist,(s_s),'-', color=lcol, lw=lw)
        ax5.plot(dist,(s_f),'-', color=lcol, lw=lw)
